...
acsDT = accuracy_score(y_test, y_predict)
...
accuraciesDT = cross_val_score(estimator=classifier,X=X,y=y,cv=10)
...
k_foldDT_validation_accuracy = accuraciesDT.mean()*100
standart_deviationDT = accuraciesDT.std()*100
